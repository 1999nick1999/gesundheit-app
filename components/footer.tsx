import { IoLogoFacebook, IoLogoTwitter, IoLogoPinterest, IoLogoInstagram, IoLogoLinkedin, IoLogoYoutube } from "react-icons/io5";
        ...
        <div className="bg-fuchsia-200 w-full px-20 py-10">
            <div className="flex justify-between">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-2">
                        <p className="text-fuchsia-500">Eerst pagina</p>
                        <p className="text-fuchsia-500">Tweede pagina</p>
                        <p className="text-fuchsia-500">Derde pagina</p>
                        <p className="text-fuchsia-500">Vierde pagina</p>
                        <p className="text-fuchsia-500">Vijfde pagina</p>
                    </div>
                </div>
                <div>
                    <h4 className="text-fuchsia-900 mb-4">SEO Column</h4>
            ...
            <div className="flex justify-between">
                ...
                <div className="flex gap-8">
                    ...
                    <p className="text-xs text-fuchsia-900">Algemene voorwaarden</p>
                </div>
            </div>
        </div>
    );
