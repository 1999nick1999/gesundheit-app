  ...
  return (
    <main className="bg-gray-200 rounded-lg pt-8 overflow-hidden">
      <div className="bg-fuchsia-900 flex items-center px-8 xl:px-20 py-4 justify-between">
        ...
        <Link href="/shop">
          <Button className="bg-fuchsia-200 text-fuchsia-900 hover:bg-fuchsia-300">
            Go to shop
          </Button>
        </Link>
      </div>
      <div className="mt-10 mb-20 px-8 xl:px-20">
        ...
        <p className="text-gray-500">
          Unveil the secret to radiant, healthy skin without breaking the bank.
          At Gesundheit, we believe everyone deserves top-notch skincare
          tailored to their unique needs, regardless of their budget. Our
          mission is simple: to deliver premium quality skincare products at
          prices that won&apost weigh you down. \n Say goodbye to compromising
          on quality or sacrificing your savings for flawless skin. With
          Gesundheit, you can confidently embrace your skincare journey, knowing
          that affordability never means compromising on effectiveness or
          luxury.
        </p>
      </div>
      <Image
      ...
      <div className="px-8 xl:px-20 py-20 flex flex-col gap-8">
        ...
        <div className="flex flex-col-reverse xl:flex-row gap-8">
          <div className="w-full xl:w-1/2 gap-2">
            ...
            <p className="text-gray-500">
              Only creating awareness for our brand with social media is way
