  ...
  return (
    <main className="bg-gray-200 rounded-lg pt-8 overflow-hidden">
      <div className="bg-fuchsia-900 flex items-center px-20 py-4 justify-between">
        ...
        <Link href="/shop"><Button className="bg-fuchsia-200 text-fuchsia-900 hover:bg-fuchsia-300">Go to shop</Button></Link>
      </div>
      ...
      <Image src={homePageImage} alt="image of products" className="w-full"></Image>
